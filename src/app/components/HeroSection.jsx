    ...
    <section className="container mx-auto px-4 py-12 lg:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5 }}
          className="col-span-1 lg:col-span-7 flex flex-col items-center lg:items-start"
        >
          <h1 className="text-white max-w-2xl mb-4 text-4xl lg:text-6xl font-extrabold text-center lg:text-left">
          ...
          <p className="text-[#ADB7BE] mb-6 text-lg lg:text-xl text-center lg:text-left">
            Hi, I&apos;m Rithend – a passionate Full Stack Developer, Cloud Enthusiast, and UI/UX Designer. I thrive on
            turning ideas into innovative digital solutions. With a strong background in web development and a keen
            interest in cloud technologies, I bring creativity and technical expertise to every project. Let&apos;s
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4">
            <a
              href="#contact"
              className="cursor-pointer bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 hover:bg-slate-200 text-white px-6 py-3 rounded-full"
            >
              Hire Me
            </a>
            <button
              onClick={() =>
                window.open(
                  "https://drive.google.com/drive/u/0/folders/1cfruLE3ECt2b0O8jI23y3UyWI7k6PXPF",
                  "_blank",
                  "noopener noreferrer"
                )
              }
              className="bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 px-1 py-1 text-white rounded-full"
            >
        ...
        >
          <div className="relative">
            <div className="bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] rounded-full">
              <Image
                src="/images/Avatar-12.png"
                alt="hero image"
                layout="fill"
